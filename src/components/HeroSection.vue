<template>
  <section class="flex flex-col min-h-screen py-10">
    ...
    <article class="flex flex-initial flex-wrap gap-8">
      <header class="basis-sm">
        <h2 class="text-2xl">About Us</h2>
        <h3 class="text-3xl">Company Name</h3>
      </header>
      <p class="basis-sm grow text-base text-justify">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Eligendi perspiciatis rerum pariatur repudiandae cum
